...
if ( defined( 'ABSPATH' ) && ! class_exists( 'Safer_WP_Admin_Login' ) ) {

	class Safer_WP_Admin_Login {
		...
		public function __construct() {
			...
			register_uninstall_hook( $this->basename(), array( 'Safer_WP_Admin_Login', 'uninstall' ) );
